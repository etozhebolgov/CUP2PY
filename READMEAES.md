...
Round 1 only has addition of the round key, and the final round only has mix columns. There are 10 rounds.<br />
...
Round 1 only has inverse mix columns, and the final round only has subtraction of the round key. There are 10 rounds again.
